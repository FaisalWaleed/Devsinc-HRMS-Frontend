  ...
  render() {
    ...
    return (
      <div>
        ...
        >
          <DialogTitle id="alert-dialog-title">{title ? title : `Are you sure you want to delete this ${this.props.resourceType}?`}</DialogTitle>
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              {message ? message : "You can not undo this action!" }
            </DialogContentText>
          </DialogContent>
          <DialogActions>
