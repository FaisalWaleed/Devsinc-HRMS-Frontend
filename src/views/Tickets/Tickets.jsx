...
import {
  createTicketFailure, createTicketSuccess, fetchAssignedTicketsFailure, fetchAssignedTicketsSuccess,
  fetchTicketsFailure,
  fetchTicketsSuccess
} from "../../actions/ticket";
              ...
              <div>
                <AppBar position="static" color={"inherit"}>
                  <Tabs centered={true} fullWidth={true} value={this.state.tab} onChange={this.handleTab}>
                    ...
                    <Tab onClick={this.props.fetchAssignedTickets} label="Assigned to Me" />
                  </Tabs>
                </AppBar>
                <br />
                {this.state.tab === 0 && <ItemGrid xs={12} sm={12} md={12}>
