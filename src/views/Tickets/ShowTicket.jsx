...
class ShowTicket extends React.Component{
  ...
  render(){
    const {classes, description, handleSubmit } = this.props;
    return(
      <div>
        <br />
        <Grid container>
            ...
            <List>
              ...
              <ListItem
                ...
                <ListItemText
                  primary={
                    <div>
                      <b>Hello </b><i>All html styling supported pretty much</i><u> i guess</u>
                      <pre><code>printf "Hello";</code></pre>
                    </div>
                  }
                  secondary={
                    <img width="100" src="https://pbs.twimg.com/profile_images/972154872261853184/RnOg6UyU_400x400.jpg" />
                  }
                >
                </ListItemText>
                <ListItemSecondaryAction>
...
export default ShowTicket = connect(null,null)(withStyles(styles)(ShowTicket));